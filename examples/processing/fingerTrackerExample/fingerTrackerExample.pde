...
void draw() {
  ...
  if(count != 0) {
    ...
    byte[] out = new byte[4];
    out[0] = (byte)map(dist(avgX, avgY, 0, 0), 0 , 665, 0, 255);
    out[1] = (byte)map(dist(avgX, avgY, 512, 0), 0 , 665, 0, 255);
    out[2] = (byte)map(dist(avgX, avgY, 0, 424), 0 , 665, 0, 255);
    out[3] = (byte)map(dist(avgX, avgY, 512, 424), 0 , 665, 0, 255);
    port.write(out);
    
    print(dist(avgX, avgY, 0, 0));
    print(", ");
    print(dist(avgX, avgY, 512, 0));
    print(", ");
    print(dist(avgX, avgY, 0, 424));
    print(", ");
    println(dist(avgX, avgY, 512, 424));
  }
